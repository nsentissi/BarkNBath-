			...
			<div class="lg:fixed lg:top-7 lg:left-14 lg:w-3/12 md:fixed md:w-5/12">
				<div class="bg-white p-8 rounded-lg shadow-md max-w-md w-full mb-4">
					...
					<div class="relative">
						...
						<img src="https://placekitten.com/150/150" alt="Profile Picture" class="absolute bottom-0 left-2/4 transform -translate-x-1/2 translate-y-1/2 w-24 h-24 rounded-full border-4 border-white"/>
					</div>
		...
		<div class="lg:col-span-2 p-4 bg-white mt-3" id="posted">
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
				...
				<div class="bg-white p-8 shadow-md rounded-lg">
					...
					{/* <!-- Image --> */}
					<div class="mb-4">
						<img src="https://placekitten.com/450/500" alt="Post Image" class="w-full h-48 object-cover rounded-md"/>
					</div>
					{/* <!-- Like and Comment Section --> */}
					<div class="flex items-center justify-between text-gray-500">
						<div class="flex items-center space-x-2">
				...
				<div class="bg-white p-8 rounded-lg shadow-md max-w-md">
					...
					{/* <!-- Image --> */}
					<div class="mb-4">
						<img src="https://placekitten.com/400/700" alt="Post Image" class="w-full h-48 object-cover rounded-md"/>
					</div>
					{/* <!-- Like and Comment Section --> */}
					<div class="flex items-center justify-between text-gray-500">
						<div class="flex items-center space-x-2">
				...
				<div class="bg-white p-8 shadow-md rounded-lg">
					...
					{/* <!-- Image --> */}
					<div class="mb-4">
						<img src="https://placekitten.com/600/300" alt="Post Image" class="w-full h-48 object-cover rounded-md"/>
					</div>
					{/* <!-- Like and Comment Section --> */}
					<div class="flex items-center justify-between text-gray-500">
						<div class="flex items-center space-x-2">
