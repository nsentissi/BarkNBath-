...
const Dash = ({ onProfileClick }) => {
  ...
  return (
    <div className={styles.area}>
      ...
      <div className="antialiased z-10  w-full min-h-screen font-playful  relative py-4">
        <div className="grid grid-cols-12 z-10 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
          <motion.div
            initial={{ x: -250 }}
            animate={{ x: 0 }}
          ...
          >
            ...
            <p className="text-black font-playful font-bold text-sm mb-4 bg-white p-2 bg-opacity-50 rounded-full">
                ...
                <div className="flex flex-row items-center space-x-2">
                  <div>
                    ...
                    >
                      <path
                        fill="currentColor"
                        d="M19 3h-1V2h-2v1H8V2H6v1H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2Zm0 16H5V8h14v11Zm-7-9H7v5h5v-5Zm2 2h2v2h-2v-2Z"
                      />
                    </svg>
                  </div>
                  <div>
          ...
          <motion.div
            initial={{ x: 250 }}
            animate={{ x: 0 }}
            transition={{ type: "spring", stiffness: 100, duration: 6 }}
            className="flex-grow z-0 bg-accent/70 col-span-9 rounded-lg p-6"
          >
            <Outlet />
          </motion.div>
        </div>
